sap.ui.define(
    ...
    function (
        ...
        return BaseController.extend("com.fe.zmroui.controller.PricingCond", {
            formatter: formatter,
            ...
            openDialog: function (oInput, bEdit) {
                ...
                if (!this._oDialog) {
                    this._oDialog = sap.ui.xmlfragment(this.createId("FrgPricingData"), "com.fe.zmroui.view.fragments.PricingConditionForm", this);
            ...
            handleAddPricingDetails: function () {
                if (!this._DialogAddPricing) {
                    this._DialogAddPricing = sap.ui.xmlfragment(this.createId("FrgAddPricingData"), "com.fe.zmroui.view.fragments.AddPricingForm", this);
            ...
            handleAddPricing: function () {
                if (!this._DialogAddPricing) {
                    this._DialogAddPricing = sap.ui.xmlfragment(this.createId("FrgAddPricing"), "com.fe.zmroui.view.fragments.AddPricingForm", this);
                    this.getView().addDependent(this._DialogAddPricing);
                }
                this._DialogAddPricing.open();
            },
